...
<?php require_once '../../_Resources/Template/Menu_Left.php'; ?>

<div class="container-fluid" id="pcont">
<div class="page-head" align="center" style="font-size:25px">
    <strong>Privilege Required</strong> 
</div>
<div class="cl-mcont">
<div class="row">
...
<div align="center">
<strong>
<p>You have not privilege required to access this page</p>
<br />
